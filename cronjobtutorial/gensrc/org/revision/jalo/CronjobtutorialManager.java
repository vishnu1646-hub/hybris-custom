...
import org.revision.constants.CronjobtutorialConstants;

/**
 * Generated class for type <code>CronjobtutorialManager</code>.
 */
@SuppressWarnings({"unused","cast"})
@SLDSafe
public class CronjobtutorialManager extends Extension
{
	...
	public static final CronjobtutorialManager getInstance()
	{
		ExtensionManager em = JaloSession.getCurrentSession().getExtensionManager();
		return (CronjobtutorialManager) em.getExtension(CronjobtutorialConstants.EXTENSIONNAME);
	}
	
	@Override
	public String getName()
	{
		return CronjobtutorialConstants.EXTENSIONNAME;
	}
